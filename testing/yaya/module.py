...
inputfile = "media\\0810.MOV"
wavfile = "media\\0810.wav"
outfile = "media\\video0810_out.mp4"
...
# 辨識是否為語音指令“剪接” ---------------------------
        ...
        try:
            s = r.recognize_google(
                audio_data=audio, key=None, language="zh-TW", show_all=True)
            if "剪接" in str(s):
